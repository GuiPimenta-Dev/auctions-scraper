...
class JSApp(Thread):
    ...
    def run(self):
        os.system(
            f'python C:\\Users\\gpimentahays\\Documents\\Freelas\\Marcella\\leilao\\auctions\\auctions\\spiders\\selenium\\{self.spider}.py "{self.city}" "{self.result_csv}.csv"')
...
class Runner:
    ...
    def run_robots(self, city):
        ...
        app25 = JSApp(spider='leiloes', city=city, result_csv=result_csv)
